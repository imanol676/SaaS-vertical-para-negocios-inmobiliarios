...
export function buildLeadScoringPrompt({ leads, criteria }: BuildPromptInput) {
  ...
  return [
    ...
    "3. Usa minimumBudget, idealBudget y optimumBudget para valorar presupuesto (están en Dólares Estadounidenses - USD. A pesar de que la app esté destinada al mercado argentino, los presupuestos se deben manejar en dolares).",
    "4. Considera las priorityZones y timeframeIdeal como señales clave. Asume que las zonas pertenecen a ciudades de Argentina.",
    "5. Evalúa el contexto desde la perspectiva del mercado inmobiliario argentino (ej: valor de propiedades en USD, tipo de cambio, jerga).",
