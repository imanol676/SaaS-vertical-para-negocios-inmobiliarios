...
export function buildLeadScoringPrompt({ leads, criteria }: BuildPromptInput) {
  ...
  return [
    ...
    "3. Usa minimumBudget, idealBudget y optimumBudget para valorar presupuesto.",
    "4. Considera priorityZones y timeframeIdeal como señales clave.",
    "5. Si faltan datos en un lead, no inventes valores; penaliza razonablemente en el score.",
    "6. Responde SOLO JSON valido, sin markdown.",
    "",
